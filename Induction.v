...
Theorem mult_0_r1 : forall n m:nat,
  ( S n ) * m = m + n * m.
Proof.
  intros.
...
Proof.
  ...
  induction n as [| n' IHn'].
  - reflexivity.
  - rewrite mult_0_r1. simpl. apply IHn'.
Qed.
...
Theorem exercises122 : forall n : nat,
  true = (n =? n).
Proof.
  intros.
  induction n as [| n'].
...
Theorem mult_comm1: forall n m : nat,
  n + n * m = n * S m.
Proof.
  intros n m.
  induction n.
...
Proof.
  ...
  - simpl. rewrite <- IHn'. rewrite mult_comm1. reflexivity.
Qed.
(** [] *)
...
Proof.
  ...
  induction b.
  - simpl. reflexivity.
  - simpl. rewrite -> Sn1. reflexivity.
  - simpl. rewrite <- IHb. simpl. rewrite -> plus_n_Sm. rewrite <- Sn2. reflexivity. Qed.
...
Proof.
  ...
  - simpl. reflexivity.
  - simpl. apply plus_1 in IHn. rewrite binary_commute in IHn. apply IHn.
Qed.
